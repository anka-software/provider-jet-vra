...
func (tr *Compute) GetObservation() (map[string]interface{}, error) {
...
func (tr *Compute) SetObservation(obs map[string]interface{}) error {
...
func (tr *Compute) GetParameters() (map[string]interface{}, error) {
...
func (tr *Compute) SetParameters(params map[string]interface{}) error {
...
func (tr *DatastoreVsphere) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *DatastoreVsphere) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *DatastoreVsphere) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *DatastoreVsphere) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
func (tr *NetworkVsphere) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *NetworkVsphere) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *NetworkVsphere) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *NetworkVsphere) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
