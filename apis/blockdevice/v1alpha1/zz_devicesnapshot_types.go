...
type DeviceSnapshotLinksObservation struct {
...
type DeviceSnapshotLinksParameters struct {
}
...
type DeviceSnapshotObservation struct {
	...
	Links []DeviceSnapshotLinksObservation `json:"links,omitempty" tf:"links,omitempty"`
