...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-jet-vra/apis/cloudaccountvmc/v1alpha1"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.AccountVmc_GroupVersionKind),
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["vra_cloud_account_vmc"])),
